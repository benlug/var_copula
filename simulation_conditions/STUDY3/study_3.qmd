...
div_summary <- rep_df |>
  ...
  summarise(
    `N Runs` = n(),
    `Total Divergences` = sum(n_div_clean),
    .groups = "drop"
  )

kable(div_summary, caption = "Divergence summary: All runs have zero post-warmup divergent transitions.")
```
