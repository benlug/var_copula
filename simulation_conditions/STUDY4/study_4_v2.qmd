...
The study employs a factorial design with two conditions varying in between-unit heterogeneity.
...
Factor = c(
  ...
  Levels = c(
    ...
    "",
    "`++` (both right-skewed)",
    "**C1**: $(0.15, 0.15)$ — Low heterogeneity; **C2**: $(0.40, 0.40)$ — High heterogeneity"
  )
)
...
::: {.callout-note}
## Design Focus: Between-Unit Heterogeneity

Study 4 focuses on the effect of between-unit heterogeneity ($\tau_\mu$) on parameter recovery. The two conditions represent low (C1: $\tau_\mu = 0.15$) and high (C2: $\tau_\mu = 0.40$) heterogeneity settings. Other factors are held constant to isolate this effect.
:::
